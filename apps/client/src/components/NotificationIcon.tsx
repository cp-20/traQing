...
export const NotificationIcon: FC<NotificationIconProps> = ({ level, ...props }) => {
  if (level === 1) return <SubscribedIcon {...props} />;
  if (level === 2) return <NotifiedIcon {...props} />;
  return <NotSubscribedIcon {...props} />;
};

const NotSubscribedIcon: FC<SVGProps<SVGSVGElement>> = (props) => (
...
const SubscribedIcon: FC<SVGProps<SVGSVGElement>> = (props) => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <title>未読のみ管理</title>
    <path
...
const NotifiedIcon: FC<SVGProps<SVGSVGElement>> = (props) => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <title>通知オン</title>
    <path
      fillRule="evenodd"
